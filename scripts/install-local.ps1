...
Write-Host "  - Set feishuDocOutput.enabled = true and feishuDocOutput.mode = on_demand to let runner create a Feishu/Lark cloud document from the Codex Markdown result."
...
Write-Host "  - Default triggerKeywords: 飞书文档, 云文档, 生成文档, 创建文档, 上传飞书, doc, docs"
